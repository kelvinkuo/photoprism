...
package com.kk.deepsync.glance.ui
...
import com.kk.deepsync.DeepSyncApplication
import com.kk.deepsync.R
import com.kk.deepsync.data.successOr
import com.kk.deepsync.glance.ui.theme.JetnewsGlanceColorScheme
...
class JetnewsGlanceAppWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        val application = context.applicationContext as DeepSyncApplication
